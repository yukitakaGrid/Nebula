...
vec3 fbm_coloring( in vec3 p ){
    ...
    col = mix( col, vec3(0.0,0.0,0.0), 1.3*dot(f,f) );
    col = mix( col, vec3(0.6,0.2,0.2), 1.1*f*f );
    col = mix( col, vec3(0.0,0.0,0.25), 0.5*smoothstep(1.2,1.3,abs(f)+abs(f)) );
